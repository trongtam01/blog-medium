      ...
      {submited ? (
        <div className="mx-auto flex max-w-2xl flex-col bg-yellow-500 p-10 text-white">
          <h3 className="text-3xl font-bold">
            Thank you for subitting your comment!
          </h3>
        ...
        >
          <h3 className="text-sm text-yellow-500">Enjoyed this art!</h3>
          ...
          <label className="mb-5 block">
            ...
            <textarea
              ...
              className="form-textarea mr-1 block w-full rounded border py-2 px-3 shadow outline-none ring-yellow-500 focus:ring"
              placeholder="Comment"
              rows={0}
            />
          </label>
